...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50),9,5,'blue',5)
    #even_better_draw_circles(rg.Point(-200,0),15,8,'red',10)
    even_better_draw_circles(rg.Point(-150,0),10,15,'blue',2)
    even_better_draw_circles(rg.Point(-100,0),5,20,'red',3)
    even_better_draw_circles(rg.Point(0,0),20,5,'orange',8)
    window.update()
